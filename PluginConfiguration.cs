...
namespace JellyfinUpscalerPlugin
{
    ...
    public class PluginConfiguration : BasePluginConfiguration
    {
        ...
        public List<ModelConfiguration> ModelConfigurations { get; set; } = new List<ModelConfiguration>();
    ...
    public class DeviceProfile
    {
        ...
        public List<DeviceProfileSetting> Settings { get; set; } = new List<DeviceProfileSetting>();
    }
    
    /// <summary>
    /// XML-serializable setting for device profiles
    /// </summary>
    ...
    /// <summary>
    /// XML-serializable custom setting
    /// </summary>
    ...
    /// <summary>
    /// XML-serializable model configuration
    /// </summary>
