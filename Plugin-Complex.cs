...
{
    /// <summary>
    /// AI Upscaler Plugin for Jellyfin v1.3.6.5 - Serialization Fixed
    /// Standard Jellyfin plugin implementation
    /// Compatible with: Jellyfin 10.10.0+
    /// </summary>
    public class Plugin : BasePlugin<PluginConfiguration>
    {
        ...
        /// </summary>
        public override string Name => $"AI Upscaler Plugin v{PLUGIN_VERSION}";
        ...
        public override string Description => 
            "AI-powered video upscaling plugin for Jellyfin. Supports multiple AI models and hardware acceleration.";
        ...
        // No service registration needed for basic plugin

        // No web pages - configuration handled through standard plugin settings
        
        /// <summary>
        /// Initialize basic plugin features
        /// </summary>
        private void InitializeEnhancedFeatures()
        {
            try
            {
                ...
                if (Configuration.AvailableAIModels == null || Configuration.AvailableAIModels.Count == 0)
                {
                    ...
                    {
                        "realesrgan", "esrgan", "swinir", "srcnn", "waifu2x", "bicubic"
                    };
                }
