// Jellyfin AI Upscaler Plugin - Player Button Integration
// Fügt einen Button im Video-Player für Schnelleinstellungen hinzu

(function() {
    'use strict';
    
    console.log('🚀 AI Upscaler Player Button wird geladen...');
